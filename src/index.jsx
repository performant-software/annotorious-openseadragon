...
class OSDAnnotorious {
  constructor(viewer, conf) {
    ...
    if (!viewerEl.style.position) viewerEl.style.position = "relative";
  ...
  destroy = () => ReactDOM.unmountComponentAtNode(this.appContainerEl);
  ...
  setDrawingEnabled = (enable) => this._app.current.setDrawingEnabled(enable);
  ...
  updateSelected = (annotation) => {
    ...
    if (updated) this._app.current.updateSelected(updated);
  };
}
